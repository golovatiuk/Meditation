...
public class AboutViewManager extends MainActivity implements View.OnClickListener, View.OnTouchListener {
    ...
    private void setNextIndicator(int index) {
        ...
        switch (index) {
            ...
            case 0:
                ((ImageView) aboutView.findViewById(R.id.aboutBottomBarIndicator2)).setImageResource(R.drawable.indicator_active);
                ((ImageView) aboutView.findViewById(R.id.aboutBottomBarIndicator1)).setImageResource(R.drawable.indicator);
                break;
            case 1:
                ((ImageView) aboutView.findViewById(R.id.aboutBottomBarIndicator3)).setImageResource(R.drawable.indicator_active);
                ((ImageView) aboutView.findViewById(R.id.aboutBottomBarIndicator2)).setImageResource(R.drawable.indicator);
                break;
    ...
    private void setPreviousIndicator(int index) {
        ...
        switch (index) {
            ...
            case 2:
                ((ImageView) aboutView.findViewById(R.id.aboutBottomBarIndicator2)).setImageResource(R.drawable.indicator_active);
                ((ImageView) aboutView.findViewById(R.id.aboutBottomBarIndicator3)).setImageResource(R.drawable.indicator);
                break;
            case 1:
                ((ImageView) aboutView.findViewById(R.id.aboutBottomBarIndicator1)).setImageResource(R.drawable.indicator_active);
                ((ImageView) aboutView.findViewById(R.id.aboutBottomBarIndicator2)).setImageResource(R.drawable.indicator);
                break;
